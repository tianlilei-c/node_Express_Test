...
describe('POST /login', () => {
  ...
  it('should return 200 and a token when login successfully', (done) => {

    findOneStub.resolves({
      username: 'teste2134124qwr',
    ...
    request(app)
      .post('/login')
      .send({ username: 'teste2134124qwr', password: 'password1234' })
      .expect(200)
...
describe('POST /register', () => {
  ...
  it('should create a new user and profile successfully', (done) => {
...
describe('PUT /headline', () => {
  ...
  it('should update the headline for an existing user', (done) => {
...
describe('POST /articles', () => {
  ...
  it('should create a new article for an existing user', (done) => {
